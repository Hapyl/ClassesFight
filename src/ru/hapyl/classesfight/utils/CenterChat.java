...
public class CenterChat {
	...
	public static void sendCenteredMessage(Player player, String message) {
		player.sendMessage(makeString(message, CENTER_PX));
	}

	public static void sendCenteredMessage(Player player, String message, Object... dot) {
		player.sendMessage(makeString(Chat.format(message, dot), CENTER_PX));
	}

	public static void sendCenteredClickableMessage(Player player, String message, HoverEvent hover, ClickEvent click) {
		final ComponentBuilder builder = new ComponentBuilder(makeString(message, CENTER_PX));
		if (hover != null)
			builder.event(hover);
		if (click != null)
			builder.event(click);
	...
	public static String makeString(String message, int centerPix) {
		...
		int toCompensate = centerPix - halvedMessageSize;
